...
WORKFLOW_OPTIMIZE_PROMPT = """You are building a Graph and corresponding Prompt to jointly solve the problems: 
"{type}"
...
the generated prompt must not contain any placeholders and **remove the comment symbols**.
